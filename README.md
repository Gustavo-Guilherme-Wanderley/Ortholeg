...
### A Ortholeg board consiste em uma placa que contém dois arduinos nanos, um conversor buck para redução de tensão, dois conectores para conexão dos encoders e mais alguns outros para comunicação do driver dos motores.
